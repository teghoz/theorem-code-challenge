**note:** *You are given more time than needed to solve the problem, so please read these instructions thoroughly. This project is setup for .NET 5. Please use your normal C# IDE/Editor for development.*
